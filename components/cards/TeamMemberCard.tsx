    ...
    <div className="grid grid-cols-1 lg:gap-[7.5]">
      <div className="flex flex-col shadow-lg bg-white rounded-xl border-[1px]">
        <div className=" flex-grow  ps-[1.875rem] pe-[1.875rem] pt-[1.25rem] pb -[1.25rem] lg:pt-9 ">
          ...
          <div className="grid justify-center gap-1 mb-3">
            ...
            <text className="text-gray-500">
              <ul className="list-disc flex gap-6">e-İzin</ul>
            </text>
          </div>
        ...
        <div className="flex items-center justify-center border-t-2 ps-[1.875rem] pe-[1.875rem] pt-[1.25rem] pb-[1.25rem] mt-[1.25rem] ">
          <Link
            href={""}
            className="h-[2rem] ps-[0.75rem] pe-[0.75rem] font-[500] text-[0.75rem] gap-[0.275rem] inline-flex items-center cursor-pointer leading-none rounded-[0.375rem] border-[1px] border-solid  outline-none bg-primaryMavi/30 hover:bg-primaryMavi hover:text-white transition-all duration-300"
          >
